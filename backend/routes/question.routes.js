...
import { getQuestionsByCategory, validateAnswer, getParticipantProgress, getCategoryFromQuestion, getParticipantProgressAll, getParticipants, getUsersWithSameOption } from '../controllers/question.controller.js';
...
router.get('/:roomId/questions/:questionId/options/:option/users', protectRoute, getUsersWithSameOption);
